...
\begin{enumerate}[noitemsep,nolistsep]
  ...
  \item information about how to write the expression; this information must include list of special
  symbols and their meaning,

  \item button that will invoke step-by-step computation,

  \item button that will invoke computation up to final solution.
...
\begin{enumerate}[noitemsep,nolistsep]
  ...
  \item button that enables the user to create \LaTeX{} source code and subsequentialy a PDF file,
...
\begin{enumerate}[noitemsep,nolistsep]
  ...
  \item information about all rules that apply to the entered word,
...
allows the user to edit \LaTeX{} source code before the PDF is created.
...
The word evaluation algorithm will use the same rules for coloring and formatting of graph of the machine as it was
